...
## 3. Case Study: Stan's Test-to-Code Ratio
...
## 4. Two Kinds of Failure: Greed vs. Sloth
...
## 5. Real Failure: the Reinhart-Rogoff Excel Error
...
## 6. Real Failure: Excel Autocorrecting Gene Names
...
## 8. The Fix: Borrow, Don't Reinvent
...
## 9. The Second Problem: Hypothesis-to-Estimator Logic
...
## 10. Case Study: the "Hot Hand" Reversal
...
## 11. A Four-Step Fix for Data Analysis
...
## 12. Practices That Close the Gap
