...
| EdStream | In-Canvas messaging | **(UF)** inside Canvas; no separate public doc found — ask via the UF Help Desk if EdStream itself needs troubleshooting |
...
- Most AIBHS coursework deliberately avoids requiring HiPerGator/UF-specific infrastructure — molab (Level 2) and a personal laptop (Level 1) are enough for most weekly work. HiPerGator (Level 4) is offered as an alternative, not a requirement.
